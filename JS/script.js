...
/*5. Напишите код который будет  спрашивать логин (prompt). Если юзер введет «admin», то дальше нужно будет спрашивать пароль, если нажал отмена – выводить «Вход отменён», когда вводит неправильный пароль то выводить  – «Я вас не знаю». Проверка пароля:  Если введён пароль «JavaScript», то выводить «Welcome», иначе – «Пароль неверен», при отмене – «Вход отменён».*/
